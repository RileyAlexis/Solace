...
public static class StatsDefinitionSeed
{
    ...
    new StatDefinition { Id = 13, Name = "Morale" },
    new StatDefinition { Id = 14, Name = "Sanity" },
    new StatDefinition { Id = 15, Name = "ActionPoints" },
    new StatDefinition { Id = 16, Name = "ActionPointsMax" },
    new StatDefinition { Id = 17, Name = "Charisma" }
    ];
}
